...
describe I2P::SAM::Client do
  ...
  describe "I2P::SAM::Client#generate_dest" do
    ...
    it "returns a key pair" do
      @client.generate_dest.should be_a(KeyPair)
    end
  end
end
